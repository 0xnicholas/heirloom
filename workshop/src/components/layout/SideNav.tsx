...
const IconHammer: React.FC = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m15 12-9.37 9.37a2.12 2.12 0 1 1-3-3L12 9" />
    <path d="m17.5 9.5 2.7 2.7a2.47 2.47 0 0 1-3.5 3.5L14 16" />
    <path d="M14 7 16 5" />
    <path d="M12 5a2.12 2.12 0 1 0 3 3L12 5z" />
  </svg>
);
...
const IconPlay: React.FC = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19V5z" />
  </svg>
);
...
const IconShieldCheck: React.FC = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const IconCheckSquare: React.FC = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const groups: NavGroup[] = [
  {
    title: 'Overview',
    items: [
      { to: '/', label: 'Stats', icon: IconBarChart },
  ...
  },
  {
    title: 'Design',
    items: [
      { to: '/schema', label: 'Schema', icon: IconLayers },
  ...
  },
  {
    title: 'Automation',
    items: [
      { to: '/actions', label: 'Actions', icon: IconPlay },
...
export function SideNav() {
  return (
    <nav className="w-56 h-full overflow-y-auto border-r border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700 py-3">
      {groups.map(group => (
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-2.5 px-4 py-1.5 text-sm transition-colors ${
                        isActive
                          ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50/80 dark:bg-indigo-950/30 font-medium'
