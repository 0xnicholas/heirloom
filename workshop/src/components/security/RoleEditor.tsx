...
export function RoleEditor({ role, allTypes, onSave, isNew: _isNew }: RoleEditorProps) {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex gap-6">
          <div>
            ...
            <select
              ...
              className="px-2 py-1.5 text-sm border rounded focus:outline-none focus:ring-1 focus:ring-indigo-300"
            >
        ...
        <div>
          ...
          {draft.actors.length === 0 && (
            <p className="text-xs text-gray-400 mb-2">No actors assigned</p>
          )}
          {draft.actors.map((actor, i) => (
            <div key={i} className="flex items-center gap-2 mb-1.5">
              <input
                ...
                className="flex-1 px-2 py-1.5 text-sm border rounded focus:outline-none focus:ring-1 focus:ring-indigo-300"
