...
import com.heirloom.pipeline.stages.PipelineEntityResolutionStage;
...
@Component
public class PipelineEntityResolutionListener extends StageConsumerTemplate {

    private final PipelineEntityResolutionStage stage;

    public PipelineEntityResolutionListener(PipelineRunJpaRepository runRepo,
                                             ...
                                             PipelineEntityResolutionStage stage) {
        super(runRepo, stageRepo, execRepo, dlqRepo, resultRepo, mapper, clock, kafkaTemplate);
        this.stage = stage;
    }

    @Override
    protected String stageName() { return "entity-resolution"; }
