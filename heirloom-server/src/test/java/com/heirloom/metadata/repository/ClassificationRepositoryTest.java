...
@DataJpaTest
@Import({ClassificationRepository.class})
@TestPropertySource(properties = {
    "spring.flyway.enabled=false",
    "spring.sql.init.mode=never",
    "spring.jpa.hibernate.ddl-auto=create"
})
@DisplayName("ClassificationRepository")
class ClassificationRepositoryTest {

    @Autowired
    private ClassificationJpaRepository jpa;
    ...
    void jpaPersistsAndDeletes() {
        var entity = new ClassificationEntity();
        entity.setName("Sensitivity");
        entity.setFullyQualifiedName("Sensitivity");
        var saved = jpa.save(entity);
